...
export const NoteCard = ({ note }) => {
  ...
  return (
    ...
    break-inside-avoid-column   border-[1px] border-gray-300 space-y-3 mx-4 sm:mx-0   sm:w-[290px] 
     p-4 max-h-fit shadow-[0_3px_5px_rgb(0,0,0,0.2)] rounded-md cursor-pointer"
      >
